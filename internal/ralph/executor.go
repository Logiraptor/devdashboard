...
type ToolEvent struct {
	// Name is the tool name (read, write, shell, search, grep, etc.)
	Name string

	// Started is true for start events, false for end events
	Started bool
	...
	// Other arguments are included as generic attributes
